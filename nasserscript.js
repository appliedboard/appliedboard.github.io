...
const profileSections = {
  general: `
    ...
    <div class="card">
      ...
      <div class="grid">
        <div><label>Prénom *</label><input type="text" value="Nasser" class="disabled-field" readonly /></div>
        <div><label>Nom *</label><input type="text" value="ABDOU DJIBO" class="disabled-field" readonly /></div>
        <div><label>Date de naissance *</label><input type="date" value="1996-12-27" class="disabled-field" readonly /></div>
	<div><label>Lieux de Naissance *</label><input type="text" value="Filingué" class="disabled-field" readonly /></div>       
        <div><label>Langue maternelle *</label><input type="text" value="Français" class="disabled-field" readonly /></div>
        <div><label>Nationalité *</label><input type="text" value="Nigérienne" class="disabled-field" readonly /></div>
        <div><label>PassePort *</label><input type="text" value="12PC08696" class="disabled-field" readonly /></div>
        <div><label>PassePort Expire Date *</label><input type="date" value="2027-08-24" class="disabled-field" readonly /></div>
        <div><label>Statut Matrimonial *</label><input type="text" value="Célibataire" class="disabled-field" readonly /></div>
        <div><label>Telephone *</label><input type="tel" value="+227 91808269" class="disabled-field" readonly /></div>
        <div><label>Adresse email *</label><input type="email" value="Abdoudjibonasser@gmail.com" class="disabled-field" readonly /></div>
        <div><label>Ville *</label><input type="text" value="Tillabéri" class="disabled-field" readonly /></div>
        <div><label>Adress *</label><input type="text" value="NIAMEY/BOBIEL" class="disabled-field" readonly /></div>
        <div><label>Code Postal *</label><input type="text" value="" class="disabled-field" readonly /></div>
  ...
  <div class="card">
    ...
    <div class="education-timeline">
      <div class="education-item" onclick="toggleEducationDetails('dut2')">
        <div class="education-header">
          <i class="fas fa-circle icon-red"></i>
          <div class="education-title">Diplôme Universitaire de Technologie (DUT2)</div>
          <i class="fas fa-chevron-down toggle-icon" id="toggle-dut2"></i>
        </div>
        <div class="education-details" id="details-dut2" style="display: none;">
          <div class="detail-row"><label>Établissement:</label><span>Institut universitaire de technologie et nutritionnelle de l'université Boubacar Bâ de Tillabéri</span></div>
          <div class="detail-row"><label>Période:</label><span>2020 - 2021</span></div>
          <div class="detail-row"><label>Spécialisation:</label><span>Génie Rural</span></div>
          <div class="detail-row"><label>Diplôme obtenu:</label><span>Oui</span></div>
        </div>
      </div>

       <div class="education-item" onclick="toggleEducationDetails('dut1')">
        <div class="education-header">
          <i class="fas fa-circle icon-red"></i>
          <div class="education-title">Diplôme Universitaire de Technologie (DUT1)</div>
          <i class="fas fa-chevron-down toggle-icon" id="toggle-dut1"></i>
        </div>
        <div class="education-details" id="details-dut1" style="display: none;">
          <div class="detail-row"><label>Établissement:</label><span>Institut universitaire de technologie et nutritionnelle</span></div>
          <div class="detail-row"><label>Période:</label><span>2019 - 2020</span></div>
          <div class="detail-row"><label>Spécialisation:</label><span>Génie Rural</span></div>
        </div>
      </div>

      <div class="education-item" onclick="toggleEducationDetails('bac')">
        <div class="education-header">
          <i class="fas fa-circle icon-red"></i>
          <div class="education-title">Baccalauréat Scientifique (Série D)</div>
          <i class="fas fa-chevron-down toggle-icon" id="toggle-bac"></i>
        </div>
        <div class="education-details" id="details-bac" style="display: none;">
          <div class="detail-row"><label>Établissement:</label><span>CES de Filingué</span></div>
          <div class="detail-row"><label>Période:</label><span>2018 - 2019</span></div>
        </div>
      </div>
      
      <div class="education-item" onclick="toggleEducationDetails('bepc')">
        <div class="education-header">
          <i class="fas fa-circle icon-red"></i>
          <div class="education-title">Brevet d'étude du premier cycle (BEPC)</div>
          <i class="fas fa-chevron-down toggle-icon" id="toggle-bepc"></i>
        </div>
        <div class="education-details" id="details-bepc" style="display: none;">
          <div class="detail-row"><label>Établissement:</label><span>CEP ALHOUDA de NIAMEY</span></div>
          <div class="detail-row"><label>Période:</label><span>2015 - 2016</span></div>
        </div>
      </div>
       <div class="education-item" onclick="toggleEducationDetails('cfepd')">
        <div class="education-header">
          <i class="fas fa-circle icon-red"></i>
          <div class="education-title">Certificat de fin d'étude du premier degré (CFEPD)</div>
          <i class="fas fa-chevron-down toggle-icon" id="toggle-cfepd"></i>
        </div>
        <div class="education-details" id="details-cfepd" style="display: none;">
          <div class="detail-row"><label>Établissement:</label><span>École primaire de Filingué</span></div>
          <div class="detail-row"><label>Période:</label><span>2009 - 2010</span></div>
        </div>
      </div>
    </div>
